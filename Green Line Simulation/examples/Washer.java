package examples;// Example 27a
// Priority Queue and Simuluation

// examples.Washer is the class that models the car washer and it's waiting line
// The method run() simulates the behavior of the washer.
// This implements the examples.Event interface (examples.Event.java)
